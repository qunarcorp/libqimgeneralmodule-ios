...
@protocol STIMWebRTCSocketClientDelegate;

@interface STIMWebRTCSocketClient : NSObject

@property(nonatomic, weak) id <STIMWebRTCSocketClientDelegate> delegate;
...
@protocol STIMWebRTCSocketClientDelegate <NSObject>
@optional
// Connected Server
